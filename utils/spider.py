...
def get_weibo_hot():
    ...
    option.add_argument("--headless")  # 隐藏浏览器
    option.add_argument("--no-sandbox")  # 禁用沙盘    部署在linux上访问chrome要求这样
    chrome_driver = '/mnt/hgfs/虚拟机共享文件夹/sweetshop1/utils/chromedriver'
    browser = Chrome(executable_path=chrome_driver, options=option)
    # browser = Chrome()
    url = "https://s.weibo.com/top/summary?cate=realtimehot"
    browser.get(url)
    # print(browser.page_source)
    c1 = browser.find_elements_by_xpath('//*[@id="pl_top_realtimehot"]/table/tbody/tr/td[2]/a')
    c2 = browser.find_elements_by_xpath('//*[@id="pl_top_realtimehot"]/table/tbody/tr/td[2]/span')
    # print(c)
    context1 = [i.text for i in c1[1:]]  # 获取标签内容
    context2 = [j.text for j in c2]
    # print(context1)
    # print(context2)
...
if __name__ == "__main__":
    ...
    # update_hotsearch()
    l = len(sys.argv)
    # 脚本本身绝对路径 D:/sweetshop1/utils/spider.py
    #print(l)
